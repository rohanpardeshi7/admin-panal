...
function SubCategoryTable() {
  ...
  const subCategories = [
    ...
    },
    {
      ...
      imageUrl: 'https://via.placeholder.com/40x40/ADD8E6/000000?text=LAP', // Another dummy image (light blue)
      order: 2,
      status: 'Deactive',
    },
    {
        ...
        imageUrl: 'https://via.placeholder.com/40x40/FF6347/FFFFFF?text=APP', // Another dummy image (tomato)
        order: 3,
        status: 'Active',
      },
